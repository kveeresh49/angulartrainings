import { Component, OnInit, Input, ViewEncapsulation, OnChanges, SimpleChange, SimpleChanges, OnDestroy } from '@angular/core';
...
export class TestServerListComponent implements OnInit,OnChanges,OnDestroy {
